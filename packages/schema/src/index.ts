import { _z, resolveZodSchemaFromSources } from "@apisr/zod";
// import type * as _Type from "@apisr/typebox";
// import { Compile } from "@apisr/typebox/compile";
// import { resolveZodSchemaFromSources } from "@apisr/zod";
...
export type InferOr<TSchema extends Schema, TOr> =
	Infer<TSchema> extends Record<string, any> ? Infer<TSchema> : TOr;
export type InferUndefined<TSchema extends Schema | undefined> =
	TSchema extends undefined ? never : Infer<Exclude<TSchema, undefined>>;

export type ExtractSchema<From extends Record<string, any> | undefined> =
	Exclude<From, undefined>["schema"];
export type ExtractSchemaFromKey<
