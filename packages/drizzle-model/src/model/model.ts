...
> {
	 ...
	 */
	where(
		value: MethodWhereValue<TConfig["schema"], TConfig["table"]>
	): Model<TConfig>;
}

export interface ModelQueryMethods<TConfig extends ModelConfig> {
	/**
 ...
 */
export type ModelBase<TConfig extends ModelConfig> = ModelMethods<TConfig> &
 ...
 */
export type Model<TConfig extends ModelConfig> = ModelIdentifier<
	TConfig["table"]["name"]
> &
	ModelBase<TConfig> &
