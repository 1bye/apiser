...
export interface ModelOptions<
	...
	TSelf extends ModelOptions<any, any, any, TSelf> = ModelOptions<
		TSchema,
		TTable,
		TDialect,
		any
...
export type ResolveOptionsMethods<
	TFactory extends ModelMethodsFactory | undefined,
> = TFactory extends ModelMethodsFactory ? TFactory : {};

export type ResolveOptionsFormat<TFormat> = TFormat extends (
	...args: any[]
) => any
	? ReturnType<TFormat>
	: undefined;
